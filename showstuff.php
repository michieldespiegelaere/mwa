    ...
    <nav class="white" role="navigation" xmlns="http://www.w3.org/1999/html">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="bierkalender.php">Bierkalender</a></li>
    ...
    <nav class="white" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a id="active" href="concept.php">Concept</a></li>
                <li><a href="inschrijven.php">Inschrijven</a></li>
                <li><a href="bierkalender.php">Bierkalender</a></li>
                <li><a href="contact.php">Contacteer ons</a></li>
                <li><a href="winkelmandje.php">Winkelmandje</a></li>
    ...
    <nav class="white" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="index.php">Home</a></li>
                <li><a href="concept.php">Concept</a></li>
                <li><a id="active" href="inschrijven.php">Inschrijven</a></li>
                <li><a href="bierkalender.php">Bierkalender</a></li>
                <li><a href="contact.php">Contacteer ons</a></li>
                <li><a href="winkelmandje.php">Winkelmandje</a></li>
            </ul>
    ...
    <nav class="white" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="concept.php">Concept</a></li>
                <li><a href="inschrijven.php">Inschrijven</a></li>
                <li><a id="active" href="bierkalender.php">Bierkalender</a></li>
                <li><a href="contact.php">Contacteer ons</a></li>
                <li><a href="winkelmandje.php">Winkelmandje</a></li>
            </ul>
...
function contactform()
{
    ...
    <div class="row">
        ...
        <div class="col s12">
            <h2 id="contacttext">U wilt ons iets vragen? Contacteer ons meteen.
            ...
            <div class="row">
                <div class="input-field col s12">
                    <select name="question">
                        <option value="Voor ik bestel">Voor ik bestel</option>
                        <option value="De betaling">De betaling</option>
